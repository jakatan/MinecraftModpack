...
public class CustomArmorItem extends ArmorItem {
    ...
    public static Item LEGGINGS = new CustomArmorItem(customMaterial, EquipmentSlotType.LEGS, properties).setRegistryName(BaseMod.MODID,"customlegs");
    public static Item BOOTS = new CustomArmorItem(customMaterial, EquipmentSlotType.FEET, properties).setRegistryName(BaseMod.MODID,"customfeet");
    //constructor
